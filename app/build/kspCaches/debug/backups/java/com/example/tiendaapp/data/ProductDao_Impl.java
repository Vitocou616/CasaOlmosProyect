...
public final class ProductDao_Impl implements ProductDao {
  ...
  public ProductDao_Impl(RoomDatabase __db) {
    ...
    this.__insertionAdapterOfProduct = new EntityInsertionAdapter<Product>(__db) {
      ...
      public String createQuery() {
        return "INSERT OR REPLACE INTO `products` (`id`,`name`,`description`,`price`,`imageRes`,`imageUrl`) VALUES (?,?,?,?,?,?)";
      }
      ...
      public void bind(SupportSQLiteStatement stmt, Product value) {
        ...
        stmt.bindLong(5, value.getImageRes());
  ...
  @Override
  public Object insert(final Product product, final Continuation<? super Unit> continuation) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      public Unit call() throws Exception {
        __db.beginTransaction();
      ...
      public List<Product> call() throws Exception {
        ...
        try {
          ...
          while(_cursor.moveToNext()) {
            ...
            _item = new Product(_tmpId,_tmpName,_tmpDescription,_tmpPrice,_tmpImageRes,_tmpImageUrl);
            _result.add(_item);
          }
          return _result;
        } finally {
  ...
  @Override
  public Flow<List<Product>> search(final String q) {
    final String _sql = "SELECT * FROM products WHERE name LIKE ? ORDER BY name ASC";
